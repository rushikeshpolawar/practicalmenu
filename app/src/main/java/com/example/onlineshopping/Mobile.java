...
public class Mobile extends AppCompatActivity {
    ...
    Integer images[]={R.drawable.redmi7,R.drawable.note10,R.drawable.iphone,R.drawable.oppo,R.drawable.lg};
    String name[]={"redmi note 7","Samsung Note 10","iphont X","OPPO V11","LG"};
    String price[]={"10000","50000","60000","80000","32000"};
    Button b1,b2,b3;
    Intent i;
