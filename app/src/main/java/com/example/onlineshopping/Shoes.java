...
public class Shoes extends AppCompatActivity {
    Integer images[]={R.drawable.nike,R.drawable.addias,R.drawable.puma,R.drawable.campus,R.drawable.redtap};
    String name[]={"Nike","Addias","Puma","Campus","Red Tape"};
    String price[]={"3500","4000","1800","1200","2200"};
    Button b1,b2,b3;
    Intent i;
